...
<body>
	<div id="header">
	  <div id="heading">iPad WebChess :: Main Menu</div>
	</div>
<div id="content">
<div id="navcontainer">
<ul id="navlist">
<li><a href="#continuegame"><?php echo gettext("Active games"); ?></a></li>
<li><a href="#invitations"><?php echo gettext("Challenges"); ?></a></li>
			...
			<div class="preferences-form">
				...
				<div class="form-block">
                                <h1><?php echo gettext("Personal information");?></h1>
                                                <div class="inputlabel"><?php echo gettext("Remember to press the 'Update' button to store your changes."); ?></div>
<br>
                                                <div class="inputlabelPrefs"><?php echo gettext("First Name:"); ?></div>
						<div><input name="txtFirstName" type="text" class="inputboxes" value="<?php echo($_SESSION['firstName']); ?>" /></div>
                                                <div class="inputlabelPrefs"><?php echo gettext("Last Name:"); ?></div>
						<div><input name="txtLastName" type="text" class="inputboxes" value="<?php echo($_SESSION['lastName']); ?>" /></div>
						<?php if ($CFG_NICKCHANGEALLOWED) { ?>
							<div class="inputlabel">Nick</div>
							<div>
								<input name="txtNick" type="text" class="inputboxes" value="<?php echo($_SESSION['nick']); ?> />
							</div>
						<?php } ?>
                                                <div class="inputlabelPrefs"><?php echo gettext("Current Password:"); ?></div>
						<div><input name="pwdOldPassword" type="password" class="inputboxes" /></div>
                                                <div class="inputlabelPrefs"><?php echo gettext("New Password:"); ?></div>
						<div><input name="pwdPassword" type="password" class="inputboxes" /></div>
                                                <div class="inputlabelPrefs"><?php echo gettext("Password Confirmation:"); ?></div>
		...
		<div class="preferences-form">
			<form name="userdata" method="post" action="mainmenu.php">
				<div class="form-block">
					...
					?>
					<div>
                                                <input type="radio" id="history1" name="rdoHistory" value="pgn"><label for="history1">PGN</label>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="radio" id="history2" name="rdoHistory" value="verbous" checked><label for="history2">Verbose</label>
					</div>
					<?php	}
					?>
					</div>
					...
					?>
                                            <div>
                                                <input type="radio" id="history3" name="rdoHistorylayout" value="columns"><label for="history3">Columns</label>
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="radio" id="history4" name="rdoHistorylayout" value="paragraph" checked><label for="history4">Paragraph</label>
											</div>
					<?php	}
					?>
					</div>
					<div class="inputlabel">Theme</div>
					<div class="inputbox"><select name="rdoTheme" class="challengeSelect">
					<?php
			...
			<div class="preferences-form">
				...
				<div class="form-block">
                                <h1><?php echo gettext("Issue a challenge");?></h1>
                                                <div class="inputlabel"><?php echo gettext("Select Your Opponent");?></div>
						<select name="opponent" class="challengeSelect">
						<?php
						...
						?>
                                                ...
                                                <div class="inputlabel" style="padding-top:10px;"><?php echo gettext("Select Your Color");?></div>
						<div class="inputbox">

<div><input type="radio" id="color1" name="color" value="random" checked><label for="color1">Random</label>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" id="color2" name="color" value="white"><label for="color2">White</label>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" id="color3" name="color" value="black"><label for="color3">Black</label></div>
			...
			<div class="preferences-form">
				...
				<div class="form-block">
						...
						<thead>
						  ...
						  <tr>
                                                        ...
                                                        <th><a href="" onclick="this.blur(); return sortTable('respInviteTblBdy', 1, true);" title="Game Id"><?php echo gettext("Id");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('respInviteTblBdy', 2, true);" title="White's handle"><?php echo gettext("White");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('respInviteTblBdy', 3, true);" title="Black's handle"><?php echo gettext("Black");?></a></th>
							...
							<?php
								...
								if (mysql_num_rows($tmpGames) == 0)
									...
									while($tmpGame = mysql_fetch_array($tmpGames, MYSQL_ASSOC))
									{
										...
										echo ("<input class=\"tableButton\" type=\"button\" value=\"" . gettext("Accept") . "\" onclick=\"sendResponse('accepted', '".$tmpFrom."', ".$tmpGame['gameID'].")\" />");
										echo ("<input class=\"tableButton\" type=\"button\" value=\"" . gettext("Decline") . "\" onclick=\"sendResponse('declined', '".$tmpFrom."', ".$tmpGame['gameID'].")\" />");
										echo("</td></tr>\n");
									}
							?>
						</tbody>
				...
				<div class="form-block">
						...
						<thead>
						  ...
						  <tr>
                                                        <th style="text-align:left;display:none;"><?php echo gettext("Rank");?></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inviteTblBdy', 1, true);" title="Game Id"><?php echo gettext("Id");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inviteTblBdy', 2, true);" title="White's handle"><?php echo gettext("White");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inviteTblBdy', 3, true);" title="Black's handle"><?php echo gettext("Black");?></a></th>
							...
							<?php
								...
								if (mysql_num_rows($tmpGames) == 0)
									...
									while($tmpGame = mysql_fetch_array($tmpGames, MYSQL_ASSOC))
									{
										...
										/* Withdraw Request */
										echo ("</td><td align=\"center\">");
										echo ("<input class=\"tableButton\" type=\"button\" value=\"" . gettext("Withdraw") . "\" onclick=\"withdrawRequest(".$tmpGame['gameID'].")\" />");
			...
			<div class="preferences-form">
				...
				<div class="form-block">
                                        <h1><?php echo gettext("Continue a game in progress");?></h1>
                                                <div class="inputlabel"><?php echo gettext("Select a game by tapping on the game id.");?></div>
						<table>
						<thead>
						  <tr>
                                                  <th class="mainHeader" colspan="7"><?php echo gettext("Games in Progress");?></th>
						  </tr>
						  <tr>
                                                        <th style="text-align:left;display:none;"><?php echo gettext("Rank");?></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inProgrTblBdy', 1, true);" title="Game Id"><?php echo gettext("Id");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inProgrTblBdy', 2, true);" title="White's handle"><?php echo gettext("White");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inProgrTblBdy', 3, true);" title="Black's handle"><?php echo gettext("Black");?></a></th>
                
                                                        <th><a href="" onclick="this.blur(); return sortTable('inProgrTblBdy',  4, true);" title="Current Turn"			 ><?php echo gettext("Current Turn");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inProgrTblBdy',  5, true);" title="Start Date of the Game"><?php echo gettext("Start Date");?></a></th>
                                                        <th><a href="" onclick="this.blur(); return sortTable('inProgrTblBdy',  6, true);" title="Date of Last Move"	 ><?php echo gettext("Last Move");?></a></th>
						  </tr>
						</thead>
...
<div><input type="radio" id="radio1" name="rdoShare" value="false"><label for="radio1">Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" id="radio2" name="rdoShare" value="all" checked><label for="radio2">No</label></div>
			...
			<div class="preferences-form">
				...
				<div class="form-block">
                                        <h1><?php echo gettext("View finished games");?></h1>
                                                <div class="inputlabel"><?php echo gettext("Select a game to view by tapping on the game id.");?></div>
						<table>
						<thead>
						  <tr>
