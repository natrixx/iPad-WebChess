...
<link rel="stylesheet" href="chess2.css" type="text/css" />
<script type="text/javascript" src="fluidic.js"></script>
...
<?php
	...
	echo 'var players = "' . $whiteNick . ' VS ' . $blackNick . "\";\n";
  ...
  <div id="innerWrapper">
    <div class="panels" id="panel1">
      ...
      <div id="content">
		...
		<input type="button" value="Close" class="button" onclick="slideIn()"><br>
		<input type="button" id="btnUndo" class="button" value="Undo" disabled="disabled" /><br>
		<input type="button" id="btnDraw" class="button" value="Draw" disabled="disabled" /><br>
		...
		<br><div id="captheading">Captures</div>
		<div id="captures"></div>
    ...
    <div class="panels" id="panel2">
      <!-- Panel2 content goes inside here -->
    	<div id="wrapper2">
			<div id="NavMenuButtons">
				<form name="gamemenu" method="post" action="chess.php">
				<input type="button" value="Game Menu" class="button" onclick="slideOut()" />
				<input type="button" id="btnMainMenu" class="button" value="Main Menu" disabled="disabled" />
	...
	<div id="boardsection">
		<form name="gamedata2" method="post" action="chess.php">
			<?php
