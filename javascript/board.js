...
{	// Returns the HTML-code for an empty chessboard (Note: Fixed square size and theme)
	...
	theBoard = '<table id="theBoard" cellpadding="0" style="border:1px solid #888; padding:0; border-collapse: collapse;border-spacing:0; box-shadow: #3B5998 0px 0px 4px; margin-bottom:5px; ">';
