...
*/
	...
	function writeStatus()
	{
		...
		if ($_SESSION['isSharedPC'])
			echo ("var whosMove = '$curColor\'s Move! The last move was&nbsp;';\n");
		elseif ($isPlayersTurn)
			echo ("var whosMove = 'It is your move! The last move was&nbsp;';\n");
		else
			echo("var whosMove = 'It is your opponent\'s move! The last move was&nbsp;';\n");
	...
	?>
		...
		<tr><td>
			...
			<input type="hidden" name="isUndoResponseDone" value="no"> <br>
			<input type="button" class="button" value="Submit" onClick="this.form.isUndoResponseDone.value = 'yes'; this.form.submit()">
		</td></tr>
		</table>
		</p>
	<?php
	...
	?>
		...
		<tr><td>
			...
			<input type="hidden" name="isDrawResponseDone" value="no"><br>
			<input type="button" class="button" value="Submit" onClick="this.form.isDrawResponseDone.value = 'yes'; this.form.submit()">
		</td></tr>
		</table>
		</p>
	<?php
